...
export function PrivacyPolicyPage() {
  return (
    <FlexBox flex={1} marginX={10}>
      ...
      <p>
        Your Infinitris Online user profile (nickname and any other information
        you provide by interacting with the service) may be shown on the
        Infinitris Online scoreboard, lobby or other pages.
      </p>
      <p>
        Infinitris Online is a free game that does not intend to invade your
        privacy in any way. We do not intend to share your private information
        (e.g. email address), but there is always a chance that we could be
        hacked or legally asked to surrender this information. Use at your own
        risk. Your progress will be saved in your online account. If you wish to
        delete your account, please create a ticket on our github.
      </p>
