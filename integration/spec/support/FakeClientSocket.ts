...
export default class FakeClientSocket implements IClientSocket, IClientSocketEventListener, IServerClientSocket
{
    id: number;
    roomId: number;
     ...
     */
    onDisconnect() {
        this._eventListeners.forEach(eventListener => eventListener.onDisconnect());
    }
    ...
    {
        this._eventListeners.forEach(eventListener => eventListener.onMessage(message));
    }
